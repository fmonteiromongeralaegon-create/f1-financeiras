export function HeroV1() {
  return (
    <div className="relative overflow-hidden text-white" style={{ background: "hsl(221 72% 14%)", minHeight: "100svh", fontFamily: "Inter, sans-serif" }}>
      {/* BG image — object-[60%_10%] no flip, gradient top→bottom */}
      <div className="absolute inset-0">
        <img
          ...
          alt=""
        />
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, hsl(221 72% 12%/.45) 0%, hsl(221 72% 12%/.82) 55%, hsl(221 72% 10%) 100%)" }} />
      </div>
